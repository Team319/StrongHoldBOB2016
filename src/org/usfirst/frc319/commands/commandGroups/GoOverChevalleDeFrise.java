...
import org.usfirst.frc319.commands.drivetrain.BuildChevalleDeFriseSpline;
 ...
 *
 */
public class GoOverChevalleDeFrise extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public GoOverChevalleDeFrise() {
    	
    	//this is where the arm should be to start the maneuver, so we call it anyway
    	addSequential(new ArmGoToAutoShootLowPosition());
    	addSequential(new BuildChevalleDeFriseSpline());
    	addParallel(new ArmGoToLowGoalThenShootUnderTower());
