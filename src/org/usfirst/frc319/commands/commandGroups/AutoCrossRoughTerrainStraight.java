 ...
 *
 */
public class AutoCrossRoughTerrainStraight extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoCrossRoughTerrainStraight() {
    	
    	
    	addSequential(new AutoDriveStraightOverDefenseToDistance(.5, 100));
