...
public class BuildPosition2Spline extends Command implements ITrajectoryChangeListener{
	
	private static final double BACK_OFF = 3.5;
	private boolean waitingForTrajectory = true;
	
	public BuildPosition2Spline() {
	...
	public void buildSpline(){
		...
		//testing
		//waypoints.add(new Waypoint(18,-7,0));
		//waypoints.add(new Waypoint (24,-8,-65));
		waypoints.add(new Waypoint(16,-7,0));
		waypoints.add(new Waypoint (18,-8,-30));
