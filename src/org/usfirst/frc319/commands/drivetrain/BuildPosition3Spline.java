...
public class BuildPosition3Spline extends Command implements ITrajectoryChangeListener{
	
	private static final double BACK_OFF = 3.5;
	private boolean waitingForTrajectory = true;
	
	public BuildPosition3Spline() {
	...
	public void buildSpline(){
		...
		**/
		//waypoints.add(new Waypoint(17,-11,0));
		//waypoints.add(new Waypoint(13,-14,0));
		waypoints.add(new Waypoint(16,-11,0));
