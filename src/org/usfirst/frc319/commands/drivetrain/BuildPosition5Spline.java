...
public class BuildPosition5Spline extends Command implements ITrajectoryChangeListener{
	
	private static final double BACK_OFF = 3.5;
	private boolean waitingForTrajectory = true;
	
	public BuildPosition5Spline() {
	...
	public void buildSpline(){
		...
		//testing
		//waypoints.add(new Waypoint(17,-20,0));
		//waypoints.add(new Waypoint (23,-19,65));
		
		waypoints.add(new Waypoint (16,-20,0));
		waypoints.add(new Waypoint (23,-19,50));
